...
<nav class="navbar navbar-light bg-dark bg-gradient fixed-top" style="padding: 15px 40px; height: 80px; width: 100%;">
    ...
    ?>
        <a class="navbar-brand text-white"
            href="http://localhost/Web_QLTHUVIEN/View/client/pages/products/dangki.php">Đăng ký</a>
        <a class="navbar-brand text-white"
            href="http://localhost/Web_QLTHUVIEN/View/client/pages/products/dangnhap.php">Đăng nhập</a>
        <?php } ?>
    </form>
</nav>
            ...
            <div class="card" style="border-radius: 15px; width: 100%;">
                ...
                <div class="card-body ">
                    <div class="modal-body">
                        ...
                        <form method="post" action="http://localhost/Web_QLTHUVIEN/Controller/account_Controller.php"
                            id="form-1">
                            <div class="form-group" style="margin-top: 2%;">
                                <label for="mkCU" class="form-label" id="basic-addon1" style="padding-right: 20px;">Mật
                                    khẩu cũ</label>
                                <input id="mk-cu" type="password" class="form-control" placeholder="Nhập mật khẩu cũ"
                                    aria-label="Username" aria-describedby="basic-addon1" name="mkCu" value="">
                                <span class="form-message invalid"></span>
                            </div>
                            <div class="form-group" style="margin-top: 2%;">
                                <label for="mkMoi" class="form-label" id="basic-addon1">Mật khẩu mới</label>
                                <input id="mk-moi" type="password" class="form-control" placeholder="Nhập mật khẩu mới"
                                    aria-label="Username" aria-describedby="basic-addon1" name="" value="">
                                <span class="form-message invalid"></span>
                            </div>
                            <div class="form-group" style="margin-top: 2%;">
                                <label for="mkMoiXN" class="form-label" id="basic-addon1">Xác nhận mật khẩu mới</label>
                                <input id="mk-moixn" type="password" class="form-control"
                                    placeholder="Nhập mật khẩu mới" aria-label="Username"
                                    aria-describedby="basic-addon1" name="mkMoi" value="">
                                <span class="form-message invalid"></span>
                            </div>
                            <div class="form-group" style="margin-top: 2%;">
                                <input type="submit" class="btn btn-primary btn-rounded btn-lg" value="Đổi mật khẩu"
                                    name="btn-doimatkhau">
                            </div>
                        </form>
                    </div>
